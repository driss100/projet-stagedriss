...
oPaginate:{sFirst:"Premier",sLast:"Dernier",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Aucune donnée n'est disponible pour la table",sInfo:"Affichage de _START_ jusqu'à _END_ sur _TOTAL_ entrées",sInfoEmpty:"Affichage de 0 jusqu'à 0 sur 0 entrées",sInfoFiltered:"(filtrage effectuée sur _MAX_ entrées)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Afficher _MENU_ Entrées",sLoadingRecords:"Chargement...",sProcessing:"En cours...",sSearch:"Chercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucune donnée correspondante à votre recherche n'a été trouvée"},oSearch:h.extend({},
